...
ActiveRecord::Schema[7.1].define(version: 2024_02_22_220608) do
  ...
  create_table "movies_locations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["filming_location_id"], name: "index_movies_locations_on_filming_location_id"
  ...
  add_foreign_key "movies_locations", "filming_locations"
